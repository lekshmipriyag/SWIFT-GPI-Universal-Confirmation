...
public class DebtorBankControllerTests {

    @Autowired
    DebtorBankController debtorBankController;
    ...
    public void testSendMT103() throws Exception {
        ...
        String produceDataToKafka = debtorBankController.sendMT103(testData);
        logger.info("result "+ produceDataToKafka);
